...
By default, the add-on automatically scans the current web page for iframe and frame tags every time you navigate to a new page or switch tabs, and updates the icon colour accordingly.

If you want to avoid automatic detection, you can disable this option. When it's disabled, you'll need to click the add-on icon to run a scan.
