...
describe("Check module import", () => {
  ...
  describe("Check function showStoredInfo", () => {
    describe("DOM elements are created correctly", () => {
      ...
      it("If values to manage", function () {
        ...
        expect(popupModule.__get__("infoContainer").innerHTML).toBe(
          '<div><div class="section sourceConfig"><button title="Delete" class="button squareButton"><img src="/icons/trash.png" alt="Delete"></button><p>https://foo.com/test.html</p></div><div class="section sourceConfig" style="display: none;"><input><button title="Update" class="button squareButton"><img src="/icons/ok.png" alt="Update"></button><button title="Cancel update" class="button squareButton"><img src="/icons/cancel.png" alt="Cancel update"></button></div></div>',
        );
      });
    });
  ...
  it("hideHtmlId adds class", function () {
    ...
    expect(document.getElementById(htmlId).className).toBe("mainMenuButton");
    function_(htmlId);
    expect(document.getElementById(htmlId).className).toBe(
      "mainMenuButton hidden",
    );
  });
